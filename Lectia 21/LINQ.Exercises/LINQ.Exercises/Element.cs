...
namespace LINQ.Exercises
{
    ...
    public class Element
    {
        ...
        {
            string result = TestData.Animals.Last(name => name.Contains('g'));
        ...
        {
            string result = TestData.Animals.First(animal => animal.Contains('s'));
        ...
        {
            TestData.Person result = TestData.People
                .Last(person => person.LastName.Last() == 'l');
